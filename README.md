...
1. Manually insert/update record. I've been either using Swagger to PUT a record in the web browser or manually making SQL calls (even less ideal because that's what the API is supposed to be for).
